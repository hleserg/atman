...
- `src/demo.py` — демо Factual Memory Adapter
- `src/demo_experience_store.py` — воспроизводимый walkthrough Experience Store (временный JSONL)
...
- **Demo (facts)**: `python3 src/demo.py`
...
1. **Feature narrative** — work package doc under `docs/development/work-packages/` and/or a feature README (e.g. [`README_EXPERIENCE_STORE.md`](README_EXPERIENCE_STORE.md)).
2. **Runnable scenario** — e.g. `make demo-experience`, or `python3 src/demo_*.py`, documented here and in the PR template.
