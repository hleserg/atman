...
- После правок **`README.md` / `README.en.md` / `MANIFEST.md` / `MANIFEST.en.md`** в корне выполните **`make sync-site-content`**, чтобы копии в `docs/content/` совпадали с сайтом на GitHub Pages.
