...
Любая задача программирования считается завершённой только если **все три проверки** пройдены с нулём ошибок:
...
Если задача затрагивает код — запустите также тесты:
...
**Правила:**
- Не коммитить код с ошибками линтера или type checker
...
- Если линтер или pyright выдают ложное срабатывание на существующем паттерне — добавить исключение в конфигурацию `pyproject.toml`, а не игнорировать ошибку
