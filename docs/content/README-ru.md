...
Мониторинг ошибок и наблюдаемость для Atman работают на [Sentry](https://sentry.io) —  
спасибо за поддержку open-source проектов. 🙏
